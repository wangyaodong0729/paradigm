...
from mne.io import read_raw_cnt, read_raw_curry
...
dataset = MetaBCIData(subjects, 1024, 'ssvep', 'ssvep')
print(dataset.subjects)
path = dataset.data_path(2)
print(path)
for isess, run_dests in enumerate(path):
    print(isess, run_dests)
