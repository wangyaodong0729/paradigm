...
class NeuroScan(BaseAmplifier):
    ...
    _COMMANDS = {
        ...
        "start_header": b'CTRL\x00\x02\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
        "stop_header": b'CTRL\x00\x02\x00\t\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    }

    def __init__(
        self,
        device_address: Tuple[str, int] = ("127.0.0.1", 4455),
        srate: float = 1024,
        num_chans: int = 36,
    ):
        super().__init__()
